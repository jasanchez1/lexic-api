...
from app.schemas.experience import EducationCreate, WorkExperienceCreate, AchievementCreate
...
REVIEWS = [
    ...
    },
    {
        ...
        "author_email": "roberto.sanchez@example.com",
        "is_hired": True,
        "is_anonymous": False
    },
    {
        ...
        "author_name": "Laura Torres",
        "author_email": "laura.torres@example.com",
        "is_hired": True,
        "is_anonymous": True
    }
]
...
ACHIEVEMENTS = [
    ...
    {
        "title": "Mejor Abogado Joven del Año",
        "year": 2018,
        "issuer": "Revista Legal"
    },
    {
...
def seed_lawyer_data():
    ...
    try:
        ...
        if reviews_count > 0:
            print(f"Database already has {reviews_count} reviews. Skipping review seeding.")
        else:
            ...
            for lawyer in lawyers:
                ...
                selected_reviews = random.sample(REVIEWS, min(num_reviews, len(REVIEWS)))
                ...
                for review_data in selected_reviews:
                    ...
                    db_review = reviews_repository.create_review(db, review_create, lawyer.id)
        ...
        if education_count > 0:
            print(f"Database already has {education_count} education entries. Skipping education seeding.")
        else:
            ...
            for lawyer in lawyers:
                ...
                selected_education = random.sample(EDUCATION, min(num_education, len(EDUCATION)))
                
                for education_data in selected_education:
                    # Create education entry
                    education_create = EducationCreate(**education_data)
                    db_education = experience_repository.create_education(db, education_create, lawyer.id)
                    count += 1
        ...
        if work_exp_count > 0:
            print(f"Database already has {work_exp_count} work experience entries. Skipping work experience seeding.")
        else:
            ...
            for lawyer in lawyers:
                ...
                selected_experiences = random.sample(WORK_EXPERIENCE, min(num_experiences, len(WORK_EXPERIENCE)))
                ...
                for experience_data in selected_experiences:
                    ...
                    db_experience = experience_repository.create_work_experience(db, experience_create, lawyer.id)
                    count += 1
        ...
        if achievement_count > 0:
            print(f"Database already has {achievement_count} achievement entries. Skipping achievement seeding.")
        else:
            ...
            for lawyer in lawyers:
                ...
                selected_achievements = random.sample(ACHIEVEMENTS, min(num_achievements, len(ACHIEVEMENTS)))
                ...
                for achievement_data in selected_achievements:
                    ...
                    db_achievement = experience_repository.create_achievement(db, achievement_create, lawyer.id)
                    count += 1
        ...
        if message_count > 0:
            print(f"Database already has {message_count} messages. Skipping message seeding.")
        else:
            ...
            for lawyer in lawyers:
                ...
                selected_messages = random.sample(MESSAGES, min(num_messages, len(MESSAGES)))
                ...
                for message_data in selected_messages:
                    ...
                    db_message = messages_repository.create_message(db, message_create, lawyer.id)
        ...
        if call_count > 0:
            ...
            for lawyer in lawyers:
                ...
                for _ in range(num_calls):
                    ...
                    db_call = messages_repository.create_call(db, call_create, lawyer.id)
                    count += 1
