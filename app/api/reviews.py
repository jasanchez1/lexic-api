...
async def update_lawyer_review(
    ...
    if db_review.lawyer_id != lawyer_id:
        raise HTTPException(status_code=400, detail="Review does not belong to this lawyer")
...
@router.delete("/{lawyer_id}/reviews/{review_id}", status_code=status.HTTP_204_NO_CONTENT)
